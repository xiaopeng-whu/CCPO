...
def run_tf_trpo_reacher_v3(
    ...
    if experiment_name is None:
        experiment_name = 'multi-constraint-test' # multi-constraint
    task_name = 'Reacher'
    # big overrides
    ...
    safety_budgets = [
        ['agent_cfg_overrides', 'safety_budget', 5.0],
    ]
    penalty_lrs = [
    ...
    for agent_name in ['CTRPO2']:
        ...
        if smoketest:
            ...
            param_list = [[seeds[0]]]
        agent_cfg_overrides['algo_name'] = 'ResponseTRPO'
        runner = TFRunner(
            experiment_name,
            agent_name,
            task_name,
