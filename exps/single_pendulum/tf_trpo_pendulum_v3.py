...
def run_tf_trpo_pendulum_v3(        
    ...
    for agent_name in [ 'CTRPO_fixed_lamda']: 
        ...
        if smoketest:
            ...
            param_list = [[seeds[0]]]
        agent_cfg_overrides['algo_name'] = 'CTRPO_fixed_lamda'
        runner = TFRunner(            
            experiment_name, 
            agent_name, 
            task_name,
