...
def plot_data(data, xaxis='Epoch', value="AverageEpRet", 
              ...
              clear_xticks=False, limit=5, **kwargs):
    # special handling for plotting a horizontal line
    #print(value)
    splits = value.split(',')
    #print("splits:",splits)
    value = splits[0]
    #value = "AverageEpCost1"	# AverageEpCost1 or AverageEpCost2
    #value2 = "AverageEpCost2"
    #if len(splits) > 1:
 ...
 (0.09019607843137255, 0.7450980392156863, 0.8117647058823529)]
    ...
    sns.tsplot(data=data, time='Epoch', value=value, unit="Unit", condition=condition, ci='sd', **kwargs)
    """
    ...
    for root, _, files in os.walk(logdir):
        if 'logs.txt' in files:
            ...
            try:
                ...
                continue
            performance = 'AverageTestEpCost' if 'AverageTestEpCost' in exp_data else 'AverageEpCost1'
...
def main():
    ...
    parser.add_argument('--value', '-y', default=['AverageEpCost1','AverageEpCost2'], nargs='*')
    parser.add_argument('--count', action='store_true')
    parser.add_argument('--smooth', '-s', type=int, default=1)
    parser.add_argument('--limit', '-t', type=int, default=5)
